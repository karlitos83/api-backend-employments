...
class WorkDaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create work_day" do
    assert_difference('WorkDay.count') do
      post work_days_url, params: { work_day: { departure_at: @work_day.departure_at, entry_at: @work_day.entry_at, user_id: @work_day.user_id } }, as: :json
    end
  ...
  test "should update work_day" do
    patch work_day_url(@work_day), params: { work_day: { departure_at: @work_day.departure_at, entry_at: @work_day.entry_at, user_id: @work_day.user_id } }, as: :json
    assert_response 200
  end
